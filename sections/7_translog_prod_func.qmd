...
collinearity_translog <- check_collinearity(translog_prod_2, verbose = FALSE) |>
    ...
    mutate(
        Term = case_when(
            Term == "qCap2_tl" ~ "log(qCap)×log(qCap)",
            Term == "qLab2_tl" ~ "log(qLab)×log(qLab)",
            Term == "qMat2_tl" ~ "log(qMat)×log(qMat)",
            Term == "qCap_qLab_tl" ~ "log(qCap)×log(qLab)",
            Term == "qLab_qMat_tl" ~ "log(qLab)×log(qMat)",
            Term == "qMat_qCap_tl" ~ "log(qMat)×log(qCap)",
