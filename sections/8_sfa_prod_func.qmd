...
summary(cd_sfa)$mleParam |>
    ...
    cols_add(description = c(
        "- Constante du modèle",
        "- Coefficient associé à la variable `log(qCap)`",
        "- Coefficient associé à la variable `log(qLab)`",
        "- Coefficient associé à la variable `log(qMat)`"
    )) |>
    ...
    tab_header(
        ...
        subtitle = md("Variable dépendante : `log(qOut)`")
    ) |>
    tab_footnote(
