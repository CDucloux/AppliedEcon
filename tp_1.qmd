...
Tout au long de ce projet, nous utiliserons l'approche `tidy` développée par @wickham2014 plutôt que l'approche `base R` pour manipuler nos données.
...
### Productivités moyenne des facteurs de production 
...
[Ajouter aussi le min/max en plus de la moyenne]{style="color:red;"}
