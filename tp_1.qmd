...
### Productivités moyennes des facteurs de production 
...
apples |> 
  ...
  labs(title = "Productivité du Capital", x = "Productivité", y = "Fréquence")
```
...
apples |> 
  ...
  labs(title = "Productivité du Travail", x = "Productivité", y = "Fréquence")
```
...
apples |> 
  ...
  labs(title = "Productivité des matériaux", x = "Productivité", y = "Fréquence")
```
