...
### Productivité moyenne des facteurs de production 
...
apples |> 
  ggplot()+
  aes(x =  log(P_Index), y = log(L_Index), size = F_Index)+
  geom_point()+
  geom_smooth(method = lm, se = FALSE)+
  labs(x = "Paasche Index", 
       y = "Laspeyres Index",
...
- En moyenne, il n'y a pas de différence de productivité globale lorsque le producteur est conseillé. La productivité moyenne avec conseil est `r round(mean_advice,2)` et la productivité moyenne sans conseil est `r round(mean_no_advice,2)`.
